...
public class ImageSlidePanel extends FrameLayout {
    ...
    private LinearLayout lastView; // 压在最底部的那个view
    ...
    private void initViewList() {
        ...
        for (int i = 0; i < num; i++) {
            LinearLayout tv = (LinearLayout) getChildAt(i);
    ...
    private void orderViewStack() {
        ...
        for (int i = 0; i < num - 1; i++) {
            LinearLayout tempView = viewList.get(i);
    ...
    private void processRotaitonAnim(int cycleNum) {
        ...
        LinearLayout tv = viewList.get(viewList.size() - 1 - cycleNum);
