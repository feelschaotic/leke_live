...
import com.juss.mediaplay.fragment.QuestionFragment;
import com.juss.mediaplay.fragment.WorkFragment;
...
public class LiveClassPlayActivity extends FragmentActivity implements OnPlayStateListener {


    private ViewPager id_class_viewpager;
    private List<Fragment> fragmentList = new ArrayList<Fragment>();
    private FragmentPagerAdapter fpAdapter;

    private LinearLayout class_question_layout;
    private LinearLayout class_homework_layout;
    ...
    private LinearLayout class_share_ll;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_live_class_play);
        judgePortOrLand();
    ...
    private void initTopBarView() {
        class_share = (ImageView) findViewById(R.id.class_share);
        class_back = (ImageView) findViewById(R.id.class_back);
        class_share_ll = (LinearLayout) findViewById(R.id.class_share_ll);

        class_back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                finish();
            }
        });
        class_share.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                openShare();
            }
    ...
    private boolean isShareLLOpen = false;

    private void openShare() {
        ObjectAnimator.ofFloat(class_share_ll, "translationY", class_share_ll.getTranslationY(), class_share_ll.getTranslationY() - class_share_ll.getHeight()).setDuration(300).start();
        isShareLLOpen = true;
    }
    ...
    private void initQuestionView() {
        id_class_viewpager = (ViewPager) findViewById(R.id.id_class_viewpager);
        class_homework_layout = (LinearLayout) findViewById(R.id.class_homework_layout);
        class_question_layout = (LinearLayout) findViewById(R.id.class_question_layout);


        WorkFragment workFragment = new WorkFragment();
        QuestionFragment quest = new QuestionFragment();
        fragmentList.add(quest);
        fragmentList.add(workFragment);
        /*  ``````````````*/
       /* WorkFragment questionDetails = new WorkFragment();
        FragmentTransaction transaction = getSupportFragmentManager()
                .beginTransaction();
        transaction.add(R.id.class_question_details_fl, questionDetails);
        ...
        id_class_viewpager.setAdapter(fpAdapter);
    ...
    private void loadDataFromIntent() {
      ...
      /*  mBundle=new Bundle();
        path="rtmp://216.mpull.live.lecloud.com/live/860505020903867?tm=20160810110309&sign=712de0ece200a463cb65ef6811d7216f";
