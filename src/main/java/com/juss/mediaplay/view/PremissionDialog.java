...
public class PremissionDialog extends Dialog {
    ...
    public PremissionDialog(Context context, int theme) {
        super(context, theme);
    }
...
//        private DialogAdapter adapter;
        ...
        public void setData(List<Permissions> list,MyOnclickStener listener){
            mapList = new ArrayList<>();
            this.listener = listener;
            for(Permissions p:list){
                Map<String,Object> map = new HashMap<>();
                map.put("name", p.getPermissionsName());
                mapList.add(map);
            }
...
//            adapter = new DialogAdapter(context, List);
        ...
        public PremissionDialog create() {
            LayoutInflater inflater = (LayoutInflater) context
                    .getSystemService(Context.LAYOUT_INFLATER_SERVICE);

            final PremissionDialog dialog = new PremissionDialog(context, R.style.Dialog);
